...
public:
    ...
    struct Hasher
    {
        ...
        {
            return std::hash<Entity>()(entity.m_id);
        };
    };
...
private:
    ...
    inline static std::queue<ID> s_ValidEntitys;
...
public:
    ...
    /** \brief Destroys this entity and all components associated with it */
    void destroy();
    ...
    template <typename T>
    inline T &addComponent(T component) const;
